    ...
    return(
        <div>
            <div className="Archives">
                ...
                <a href={issue2} target="__blank" > <img className="eye2"  src={eye} alt="" /></a>
                <Link download={issue2} target="__blank"> <img className="download2" src={download} alt="" /></Link>
                <h1 className="number03">03</h1>
                <p className="thirdedition">Third Edition</p>
                <a href={issue3} target="__blank" > <img className="eye3"  src={eye} alt="" /></a>
                <Link download={issue3} target="__blank"> <img className="download3" src={download} alt="" /></Link>
                <h1 className="number04">04</h1>
                <p className="fourthedition">Fourth Edition</p>
                <a href={issue4} target="__blank" > <img className="eye4"  src={eye} alt="" /></a>
                <Link download={issue4} target="__blank"> <img className="download4" src={download} alt="" /></Link>
                <h1 className="number05">05</h1>
                <p className="fifthedition">Fifth Edition</p>
                <a href={issue4} target="__blank" > <img className="eye5"  src={eye} alt="" /></a>
                <Link download={issue4} target="__blank"> <img className="download5" src={download} alt="" /></Link>
            </div>
